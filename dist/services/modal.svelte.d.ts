...
import { type ConfirmModalProps } from "../components/functional/confirm-modal";
...
export declare const modalService: {
    ...
    confirm: (title: ConfirmModalProps["title"], text?: ConfirmModalProps["text"], rest?: Omit<ConfirmModalProps, "title" | "text" | "onClose">) => Promise<import("../components/functional/confirm-modal").ConfirmResult>;
};
export {};
